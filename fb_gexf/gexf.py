...
class Gexf:
    ...
    def write(self, file, print_stat=True):
        # file.write(type(etree.tostring(self.getXML(), pretty_print=True, encoding='utf-8', xml_declaration=True)))
        file.write(etree.tostring(self.getXML(), pretty_print=True, encoding='unicode', xml_declaration=False))
